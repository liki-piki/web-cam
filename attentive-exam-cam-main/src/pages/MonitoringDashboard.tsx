...
import { ArrowLeft, AlertTriangle, Eye, Smartphone, TrendingUp } from 'lucide-react';
import { AlertEvent } from '@/lib/attentionScoring';
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {formatTime(Date.now() - selectedSession.startTime)}
                  </p>
                </div>
